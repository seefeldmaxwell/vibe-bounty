...
export default function SubmitToBountyClient({ id }: { id: string }) {
  ...
  const parsedTech = form.techUsed
    .split(",")
    .map((t) => t.trim())
    .filter(Boolean);
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="Describe your approach, key decisions, features implemented, and anything else the poster should know..."
              rows={8}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 bg-card border border-border rounded-xl text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-accent/50 focus:ring-1 focus:ring-accent/25 transition-colors text-sm font-mono"
              />
            </div>
          </div>
            ...
            <div
              ...
              className={cn(
                ...
                dragActive
                  ...
                  : "border-border hover:border-border-bright bg-card"
              )}
            >
              <div className="flex flex-col items-center justify-center py-10 px-4">
                ...
                <p className="text-xs text-muted-foreground">
                  or click to browse - ZIP, images, videos up to 50MB
                </p>
              </div>
            </div>
                ...
                {files.map((file, i) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="p-1 rounded hover:bg-surface text-muted-foreground hover:text-danger transition-colors"
                    >
