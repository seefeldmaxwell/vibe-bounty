...
const footerLinks = {
  ...
  Company: [
    ...
    { label: "Twitter", href: "https://x.com/vibebounty" },
  ],
};
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/seefeldmaxwell/vibe-bounty" aria-label="GitHub" className="text-muted-foreground hover:text-foreground transition-all hover:scale-110">
              <Github className="h-4 w-4" />
            </a>
            <a href="https://x.com/vibebounty" aria-label="Twitter" className="text-muted-foreground hover:text-foreground transition-all hover:scale-110">
